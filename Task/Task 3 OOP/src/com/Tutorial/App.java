...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println((adi.collectPay() == 5000000.0 ? "Correct Adi's collectPay()" : "Wrong Adi's collectPay()"));
        adi.retire();
        System.out.println(adi);
        ...
        System.out.println((asep.collectPay() == 8650000.0 ? "Correct Asep's collectPay()" : "Wrong Asep's collectPay()"));
